    ...
    <section className='bg-gradient-to-r from-[#FBEEE9] to-[#8D6DFB]'>
       ...
       <div className='flex justify-between items-start w-full max-custom:flex-col max-custom:items-start max-custom:gap-5 max-custom:my-5'>
            <div className='flex justify-center flex-col'>
                ...
                <p className=' w-[400px] my-3 max-custom:w-full'>I'm a senior software engineer with 1 year of experience in industry standards. I have completed multiple real-time projects for clients and have deep knowledge of HTML, CSS, JavaScript, React.js, Next.js, Node.js, Express.js, MongoDB, and MySQL.</p>
