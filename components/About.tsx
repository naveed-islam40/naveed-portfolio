...
const cards = [
  ...
  },
  {
    ...
    icon: ServerIcon,
    description:
      "I'm a backend developer who works with Node.js, Express.js, and Python to build and maintain the server-side of web applications. I manage data flow, implement business logic, and create APIs. My expertise includes working with databases like MongoDB, PostgreSQL, and MySQL. I ensure that applications are scalable, secure, and efficient.",
    color: "bg-purple-100",
  },
  {
    ...
    icon: DatabaseIcon,
    description:
      "I'm a database specialist skilled in designing, implementing, and managing databases for both relational (PostgreSQL, MySQL) and non-relational (MongoDB) systems. I focus on data modeling, query optimization, and ensuring data integrity and security. My experience includes optimizing performance, backup and recovery strategies, and maintaining the integrity of data across applications.",
    color: "bg-blue-100",
  },
  {
    ...
    icon: CodeIcon,
    description:
      "I'm a full stack developer with a comprehensive understanding of both frontend and backend technologies. I can work on all layers of web applications, from user interface design to server-side logic and database management. With expertise in React, Next.js, Node.js, MongoDB, and PostgreSQL, I'm capable of handling diverse project requirements efficiently.",
    color: "bg-green-100",
  },
];
