    ...
    <div className="min-h-screen bg-gradient-to-br from-white to-purple-100 p-8">
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-12">
          <h1 className="text-4xl font-bold text-[#8B5CF6] mb-2">About Naveed</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            ...
            My name is Naveed Islam, and I am an accomplished web developer who enjoys turning concepts into beautiful web applications. I have a very good grasp of aesthetics, while writing clean codes and developing applications is an added advantage. As a result, I design digital experiences that are unforgettable.
            </p>
            <p className="text-gray-700">
          ...
          <Card className="bg-white shadow-lg">
            <CardContent className="p-6">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center">
                  <Code className="text-[#8B5CF6] mr-2" />
                  <span>Backend-end Development (Node js, Spring & Spring Boot)</span>
                </li>
                <li className="flex items-center">
